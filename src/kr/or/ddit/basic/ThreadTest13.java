...
class Horse extends Thread implements Comparable<Horse> {
	...
	// 말이 달리기 하는 부분을 쓰레드로 처리한다.
	@Override
	public void run() {
		// 경기 구간은 1~50구간으로 되어있다.
		// 말의 현재위치는 현재 말이 달리고 있는 현재의 구간 겂이 저장된다.
		for (int i = 1; i <= 50; i++) {
...
/*
 * 
 * 경기가 진행되는 동안에는 중간 중간에 각 말들의 위치를 나타내시오. 예) 말이름1:
 * ---->------------------------------- 말이름1:
 * ------->---------------------------- ... 말이름10:
 * -->---------------------------------
 */
...
//			if (Horse.currnetRank == horses.length) {
//				break;
//			}
			...
			System.out.println("전: " + isInterrupted());
			if(isInterrupted()) {
				break;
